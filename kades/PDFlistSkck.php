...
<title>Surat Ket. Catatan Kepolisisan</title>
</head>
<body>
<table border="0">
	<tr>
...
<!--JUDUL TABEL DISINI-->
<h3 align='center'>SURAT KETERANGAN CATATAN KEPOLISIAN</h3>
<table align="center" class="table table-bordered" border="1" width="100%">
	...
	//pilih tabel
	$query=mysql_query("SELECT*FROM skck");
	//tampilkan record
	while($data=mysql_fetch_array($query)){
		...
		?>
		<tr>
			<td align="center"><?php echo $skckID;?></td>
			<td><?php echo $nama;?></td>
