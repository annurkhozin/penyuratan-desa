...
<form action="" method="post" class="bg-info">
	...
	<table class="table table-condensed table-bordered table-striped">
		...
		<tr>
			...
			<td>:</td>
			<td><input class="form-control" type="text" name="tglSukem" value="<?php echo $data['tglSukem'];?>" /></td>
		</tr>
		<tr>
		...
		<tr>
			<td>Tanggal Wafat</td>
			<td>:</td>
			<td><input class="form-control" type="text" name="tglWafat" value="<?php echo $data['tglWafat'];?>" /></td>
		</tr>
		</tr>
		<tr>
			<td>Wafat Di</td>
