...
if(isset($_POST['tambah'])){
	...
	$simpan=mysql_query("INSERT INTO suket VALUES(NULL,'$jenisSuket','$noSuket','$tglSuket','$fullname','$lahirDi','$tglLahir','$jenKelamin','$pekerjaan','$agama','$status','$keperluan','$alamat','$ket')")or die(mysql_error());
...
<form action="" method="post" class="bg-info">
	<table class="table table-condensed table-bordered table-striped">
		...
		<tr>
			<td>Tanggal Surat</td>
			<td>:</td>
			<td><input class="form-control" type="text" name="tglSuket" value='<?php echo date('d-m-Y');?>'/></td>
		</tr>
		<tr>
			<td>Nama Lengkap</td>
			<td>:</td>
