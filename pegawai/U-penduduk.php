...
if(isset($_POST['perbarui'])){
	...
	//simpan database
	$update=mysql_query("UPDATE penduduk SET pendID='$id', noKK='$noKK', namaLengkap='$namaLengkap', nik='$nik', jenKelamin='$jenKelamin', tempatLahir='$tempatLahir', tglLahir='$tglLahir', umur='$umur', agama='$agama', pendidikan='$pendidikan', jenPekerjaan='$jenPekerjaan', statusNikah='$statusNikah', statHubKel='$statHubKel', wargaNeg='$wargaNeg', noPaspor='$noPaspor', kitasKitap='$kitasKitap', namaAyah='$namaAyah', namaIbu='$namaIbu', alamat='$alamat', rt='$rt', rw='$rw', desaKel='$desaKel', kecamatan='$kecamatan', kabKota='$kabKota', kodePos='$kodePos', provinsi='$provinsi' WHERE pendID='$id'")or die(mysql_error());
