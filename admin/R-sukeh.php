...
<a class="btn btn-primary btn-sm" href="javascript:void(0);" onclick="window.open('PDFlistSukeh.php?kode=','nama_window_pop_up','size=800,height=800,scrollbars=yes,resizeable=no')"><span class="glyphicon glyphicon-print"></span> Cetak</a>
</p>
	...
	while($r=mysql_fetch_array($sql)){?>
		<tr>
			...
			<td align="center">
				...
				<a class="btn btn-danger btn-xs" href="?pages=Dsukeh&id=<?php echo $r[sukehID];?>"><span class="glyphicon glyphicon-trash"></span></a>
			</td><?php
	}?>
	</tr>
</table>
