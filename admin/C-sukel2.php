...
if(isset($_POST['tambah'])){
	...
	$data_penyuratan["id_keperluan"] = 3;
	...
	$tglSukel=date_format(date_create($_POST['tglSukel']),"Y-m-d");
	...
	$simpan=mysql_query("INSERT INTO sukel VALUES(NULL,'$noSukel','$tglSukel','$namaAnak','$anakKe','$lahirDi','$hariLahir','$tglLahir','$jenKelamin','$namaIbu','$umurIbu','$alamatIbu','$namaBapak','$umurBapak','$alamatBapak','$id_penyurataan')")or die(mysql_error());
...
<div class="panel panel-primary">
	...
	<table class="table table-condensed table-bordered table-striped">
		<tr>
			<td>Tanggal Surat</td>
			<td>:</td>
			<td><input class="form-control" type="date" name="tglSukel" value='<?php echo date('Y-m-d');?>'/></td>
		</tr>
		<tr>
