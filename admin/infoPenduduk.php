...
if(isset($_POST['submit'])){
	$cari=$_POST['cari'];
	$q=mysql_query("SELECT*FROM penduduk WHERE namaLengkap LIKE '%$cari%' OR noKK LIKE '%$cari%' OR nik LIKE '%$cari%' OR namaAyah LIKE '%$cari%' OR namaIbu LIKE '%$cari%' ")or die(mysql_error());
	while($data=mysql_fetch_array($q)){?>
	<tr>
		<td class="bg-primary" colspan="3"><h3 align="center">Nama Penduduk</h3></td>
	</tr>
	<tr>
		<td colspan="3">
