...
<a class="btn btn-success btn-sm" href="?pages=Cuser"><span class="glyphicon glyphicon-plus"></span> Baru</a>
...
<table class="table table-bordered table-striped table-hover">
	...
	while($r=mysql_fetch_array($sql)){?>
		<tr>
			...
			<td align="center">
				<a class="btn btn-warning btn-xs" href="?pages=Uuser&id=<?php echo $r[userID];?>"><span class="glyphicon glyphicon-pencil"></span></a>
				<a class="btn btn-danger btn-xs" href="?pages=Duser&id=<?php echo $r[userID];?>"><span class="glyphicon glyphicon-trash"></span></a>
			</td><?php
	}?>
	</tr>
</table>
