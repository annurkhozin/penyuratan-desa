...
<form action="" method="post" class="bg-info">
	...
	<table class="table table-condensed table-bordered table-striped">
		...
		<tr>
			<td>Tanggal SKCK</td>
			<td>:</td>
			<td><input class="form-control" type="date" name="tglSkck" value="<?php echo $data['tglSkck'];?>" /></td>
		</tr>
		<tr>
			<td>Nama</td>
			<td>:</td>
		...
		<tr>
			<td>Berlaku</td>
			<td>:</td>
			<td><input class="" type="date" name="berlaku" value="<?php echo $data['berlaku'];?>" /> s/d <input class="" type="date" name="sd" value="<?php echo $data['sd'];?>" /></td>
		</tr>
	</table>
