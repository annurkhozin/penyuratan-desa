...
if(isset($_POST['perbarui'])){
	...
	//simpan database
	$update=mysql_query("UPDATE user SET userID='$id', fullname='$fullname', alamat='$alamat', tempatLahir='$tempatLahir', tglLahir='$tglLahir', jenKelamin='$jenKelamin', umur='$umur', agama='$agama', pendidikan='$pendidikan', statusNikah='$statusNikah' WHERE userID='$id'")or die(mysql_error());
