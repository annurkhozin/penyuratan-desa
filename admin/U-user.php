...
if(isset($_POST['perbarui'])){
	...
	//simpan database
	$update=mysql_query("UPDATE user SET userID='$id', fullname='$fullname', username='$username', password='$password', level='$level', alamat='$alamat', tempatLahir='$tempatLahir', tglLahir='$tglLahir', jenKelamin='$jenKelamin', agama='$agama', pendidikan='$pendidikan', statusNikah='$statusNikah' WHERE userID='$id'")or die(mysql_error());
...
<form action="" method="post" class="bg-info">
	...
	<table class="table table-condensed table-bordered table-striped">
		...
		<tr>
			<td>Password</td>
			<td>:</td>
			<td><input class="form-control" type="text" name="password" placeholder="Kosongi jika tidak ada perubahan Password!" /></td>
			<input class="form-control" type="hidden" name="password_lama" value="<?php echo $data['password'];?>" />
		</tr>
		<tr>
			<td>Level</td>
			<td>:</td>
