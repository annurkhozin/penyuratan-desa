...
if(isset($submit)){
	if($jenisSurat==1){?>
		<script>document.location.href="?pages=Cktp2&nik=<?php echo $nik;?>";</script><?php
	}else if($jenisSurat==2){?>
		<script>document.location.href="?pages=Csuket2&nik=<?php echo $nik;?>";</script><?php
	}else if($jenisSurat==3){?>
		<script>document.location.href="?pages=Csukel2&nik=<?php echo $nik;?>";</script><?php
	}else if($jenisSurat==4){?>
		<script>document.location.href="?pages=Csukem2&nik=<?php echo $nik;?>";</script><?php
	}else if($jenisSurat==5){?>
		<script>document.location.href="?pages=Csktm2&nik=<?php echo $nik;?>";</script><?php
	}else if($jenisSurat==6){?>
		<script>document.location.href="?pages=Cskck2&nik=<?php echo $nik;?>";</script><?php
	}else if($jenisSurat==7){?>
		<script>document.location.href="?pages=Csukeh2&nik=<?php echo $nik;?>";</script><?php
	}
}else{
	unset($submit);
}
